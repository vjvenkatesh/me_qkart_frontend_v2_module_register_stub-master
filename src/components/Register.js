    ...
    >
      ...
      <Box className="content">
        <Stack spacing={2} className="form">
          ...
          />
          {isLoading ? (<div className="loading"><CircularProgress color="success"/></div>):(<Button className="button" variant="contained" onClick={handleRegisterClick}>REGISTER NOW</Button>)}
